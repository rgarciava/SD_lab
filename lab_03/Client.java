...
public class Client {
    ...
    public boolean start() {
        ...
        // this is the only message that we will send as a String.
        // All other messages will be ChatMessage objects
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "1. Simply type the message to send " +
                "broadcast to all active clients"
        );

        System.out.println(
                "2. Type '@username<space>yourmessage' " +
                "without quotes to send message to desired client"
        );

        System.out.println(
                "3. Type 'WHOISIN' without quotes " +
                "to see list of active clients"
        );

        System.out.println(
                "4. Type 'LOGOUT' without quotes " +
